    ...
    <div class="container">
        <div class="row align-items-center py-5">
            ...
            <div class="col-lg-5 px-lg-4">
                <h2 class="text-base text-primary text-uppercase mb-4">疫情物资管理系统</h2>
                <p class="text-muted">欢迎使用疫情物资管理系统后台管理系统</p>
                <form id="loginForm" action="authAdminLogin.do?a=a" class="mt-4" method="post">
                    ...
                    <div class="form-group mb-4">
                        <input type="text" name="pagerandom" placeholder="验证码"
                               class="form-control border-0 shadow form-control-lg text-violet"
                               style="width: 180px;display: inline-block"/>
                        <img alt="刷新验证码" title="点击刷新验证码"
                             onClick="this.src='captcha.do?time='+new Date().getTime();"
                             src="captcha.do"
                             style="cursor:pointer; padding-top:10px;width: 60px;height: 40px;float: right">
                    </div>
                    <button type="submit" class="btn btn-primary shadow px-5">登录</button>
                </form>
            </div>
        </div>
        <p class="mt-5 mb-0 text-gray-400 text-center">Copyright &copy; 疫情物资管理系统</p>
    </div>
</div>
<!-- JavaScript files-->
