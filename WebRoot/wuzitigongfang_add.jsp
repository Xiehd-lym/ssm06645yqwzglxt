...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="wuzitigongfanginsert.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入名称" style="width:250px;" data-rule-required="true" data-msg-required="请填写名称" remote="checkno.do?checktype=insert&table=wuzitigongfang&col=mingcheng" data-msg-remote="内容重复了" id="mingcheng" name="mingcheng" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入负责人" style="width:150px;" id="fuzeren" name="fuzeren" value=""/>                                            
        </div>
