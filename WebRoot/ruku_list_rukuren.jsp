...
<div class="panel panel-default">
    ...
    类型
                            ...
                            <select class="form-control class_leixing49" data-value="${param.leixing}" id="leixing" name="leixing">
...
<script>
$(".class_leixing49").val($(".class_leixing49").attr("data-value"))</script>
                        
</div>
                                                                                    <div class="form-group">
    入库类型
    
                            <select class="form-control class_rukuleixing50" data-value="${param.rukuleixing}" id="rukuleixing" name="rukuleixing">
...
<script>
$(".class_rukuleixing50").val($(".class_rukuleixing50").attr("data-value"))</script>
...
<th> 入库人  </th>
                    ...
                    <tr id="${map.id}" pid="">
                        ...
                        <td> ${map.mingcheng} </td>
<td> <ssm:sql var="mapwuzileibie36" type="find">SELECT leibiemingcheng FROM wuzileibie where id='${map.leixing}'</ssm:sql>${mapwuzileibie36.leibiemingcheng} </td>
<td> ${map.danhao} </td>
<td> ${map.rukuleixing} </td>
<td> ${map.rukushuliang} </td>
<td> ${map.rukushijian} </td>
<td> <ssm:sql var="mapwuzitigongfang37" type="find">SELECT mingcheng FROM wuzitigongfang where id='${map.wuzitigongfang}'</ssm:sql>${mapwuzitigongfang37.mingcheng} </td>
