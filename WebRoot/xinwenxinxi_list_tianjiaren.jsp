...
<div class="panel panel-default">
    ...
    分类
                            ...
                            <select class="form-control class_fenlei15" data-value="${param.fenlei}" data-rule-required="true" data-msg-required="请填写分类" id="fenlei" name="fenlei">
...
<th> 点击率  </th>
                    ...
                    <tr id="${map.id}" pid="">
                        ...
                        <td> ${map.biaoti} </td>
<td> <ssm:sql var="mapxinwenfenlei3" type="find">SELECT fenleimingcheng FROM xinwenfenlei where id='${map.fenlei}'</ssm:sql>${mapxinwenfenlei3.fenleimingcheng} </td>
<td> <c:choose>
