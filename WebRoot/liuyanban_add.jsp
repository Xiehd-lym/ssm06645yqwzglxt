...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入联系电话" style="width:150px;" data-rule-required="true" data-msg-required="请填写联系电话" id="lianxidianhua" name="lianxidianhua" value="${sessionScope.shouji}"/>                                            
        </div>
                                                        ...
                                                        <div class="form-group">
    <div class="row">
        <label style="max-width: 120px;min-height:18px;text-align: right" class="col-sm-2 hiddex-xs">留言内容<span style="color: red;">*</span></label>
        <div class="col-sm-10">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" placeholder="输入留言内容" data-rule-required="true" data-msg-required="请填写留言内容" id="liuyanneirong" name="liuyanneirong"></textarea>                                            
                                                        ...
                                                        <div class="form-group">
    <div class="row">
        <label style="max-width: 120px;min-height:18px;text-align: right" class="col-sm-2 hiddex-xs">留言人</label>
        <div class="col-sm-10">
            
                                                    <input type="text" class="form-control" placeholder="输入留言人" style="width:150px;" readonly="readonly" id="liuyanren" name="liuyanren" value="${sessionScope.username}"/>                                            
        </div>
