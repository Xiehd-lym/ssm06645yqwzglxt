...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="wuzixinxiinsert.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入编号" style="width:150px;" readonly="readonly" id="bianhao" name="bianhao" value="${Info.getID()}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入名称" style="width:250px;" id="mingcheng" name="mingcheng" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_leixing20" data-value="" id="leixing" name="leixing" style="width:250px">
...
<option value="${m.id}">${m.leibiemingcheng}</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_danwei21" data-value="" id="danwei" name="danwei" style="width:250px">
...
<option value="箱">箱</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_wuzitigongfang22" data-value="" id="wuzitigongfang" name="wuzitigongfang" style="width:250px">
...
<option value="${m.id}">${m.mingcheng}</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="输入库存" style="width:150px;" data-rule-required="true" data-msg-required="请填写库存" number="true" data-msg-number="输入一个有效数字" min="1" id="kucun" name="kucun" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <textarea id="miaoshu" name="miaoshu" style="max-width: 750px;width:100%; height: 300px;"></textarea><script>
            (function(){
