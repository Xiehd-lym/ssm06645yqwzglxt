            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_leixing35" data-value="${param.leixing}" id="leixing"
                                name="leixing">
                        ...
                        <script>
                            $(".class_leixing35").val($(".class_leixing35").attr("data-value"))</script>

                    </div>
                    <div class="form-group">
                        申请类型

                        <select class="form-control class_shenqingleixing36" data-value="${param.shenqingleixing}"
                        ...
                        <script>
                            $(".class_shenqingleixing36").val($(".class_shenqingleixing36").attr("data-value"))</script>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <c:set var="i" value="0"/><c:forEach items="${list}" var="map"><c:set var="i" value="${i+1}"/>
                        <tr id="${map.id}" pid="">
                            ...
                            <td> ${map.mingcheng} </td>
                            <td><ssm:sql var="mapwuzileibie23"
                                         type="find">SELECT leibiemingcheng FROM wuzileibie where id='${map.leixing}'</ssm:sql>${mapwuzileibie23.leibiemingcheng} </td>
