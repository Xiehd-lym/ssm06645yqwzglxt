...
<header class="header">
    <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
        ...
        <a href="index.html" class="font-weight-bold text-uppercase text-base">疫情物资管理系统</a>
...
<div class="d-flex align-items-stretch">
    ...
    <div id="sidebar" class="sidebar py-3">
        <ul class="sidebar-menu list-unstyled">
            ...
            <c:choose>
                <c:when test="${'物资管理部' == sessionScope.cx }">

                    <%@ include file="left_wuziguanlibu.jsp" %>
                </c:when></c:choose>
            <c:choose>
