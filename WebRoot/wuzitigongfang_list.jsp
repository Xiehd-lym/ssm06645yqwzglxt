...
<div class="panel panel-default">
    ...
    负责人
                            ...
                            <input type="text" class="form-control" style="" name="fuzeren" value="${param.fuzeren}"/>                        
</div>
...
<td> ${map.dizhi} </td>
                        ...
                        <td align="center">
                                                                ...
                                                                <a href="wuzitigongfang_updt.do?id=${map.id}">编辑</a>
                                                                <a href="wuzitigongfang_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    </c:forEach>
