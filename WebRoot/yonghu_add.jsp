...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_xingbie6" data-value="" id="xingbie" name="xingbie" style="width:250px">
...
<option value="女">女</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_bumen7" data-value="" data-rule-required="true" data-msg-required="请填写部门" id="bumen" name="bumen" style="width:250px">
