...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <ssm:sql var="mapwuzileibie21" type="find">SELECT leibiemingcheng FROM wuzileibie where id='${readMap.leixing}'</ssm:sql>${mapwuzileibie21.leibiemingcheng}<input type="hidden" id="leixing" name="leixing" value="${Info.html(readMap.leixing)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_shenqingleixing32" data-value="" id="shenqingleixing" name="shenqingleixing" style="width:250px">
