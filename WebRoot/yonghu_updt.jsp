...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_xingbie10" data-value="${Info.html(mmm.xingbie)}" id="xingbie" name="xingbie" style="width:250px">
<option value="男">男</option>
<option value="女">女</option>

</select>
<script>
$(".class_xingbie10").val($(".class_xingbie10").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_bumen11" data-value="${Info.html(mmm.bumen)}" data-rule-required="true" data-msg-required="请填写部门" id="bumen" name="bumen" style="width:250px">
...
<script>
$(".class_bumen11").val($(".class_bumen11").attr("data-value"))</script>
