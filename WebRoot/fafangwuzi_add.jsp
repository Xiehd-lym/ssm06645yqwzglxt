...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="fafangwuziinsert.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <ssm:sql var="mapwuzileibie32" type="find">SELECT leibiemingcheng FROM wuzileibie where id='${readMap.leixing}'</ssm:sql>${mapwuzileibie32.leibiemingcheng}<input type="hidden" id="leixing" name="leixing" value="${Info.html(readMap.leixing)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',lang:'zh-cn'})" style="width:200px;" id="fafangshijian" name="fafangshijian" readonly="readonly" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" placeholder="输入发放备注" id="fafangbeizhu" name="fafangbeizhu"></textarea>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入发放人" style="width:150px;" readonly="readonly" id="fafangren" name="fafangren" value="${sessionScope.username}"/>                                            
        </div>
