...
<c:when test="${sessionScope.username != null && sessionScope.username !=  '' }">
                    ...
                    <li><a href="main.do"><i class="icon icon-user"></i>${sessionScope.username},${sessionScope.cx}</a></li>
...
<li>
<a href="quanguoyiqinglist.do">池州疫情
</a>
</li>
<li>
<a href="jiankangdakaadd.do">健康打卡
</a>
</li>
<li>
