...
<div class="container" style="max-width:450px"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        <label style="max-width: 120px;min-height:18px;text-align: right" class="col-sm-2 hiddex-xs">原密码<span style="color: red;">*</span></label>
        <div class="col-sm-10">
                ...
                <div class="form-group">
    <div class="row">
        <label style="max-width: 120px;min-height:18px;text-align: right" class="col-sm-2 hiddex-xs">新密码<span style="color: red;">*</span></label>
        <div class="col-sm-10">
                ...
                <div class="form-group">
    <div class="row">
        <label style="max-width: 120px;min-height:18px;text-align: right" class="col-sm-2 hiddex-xs">确认密码<span style="color: red;">*</span></label>
        <div class="col-sm-10">
