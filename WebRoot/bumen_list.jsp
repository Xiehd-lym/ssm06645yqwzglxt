...
<div class="panel panel-default">
    ...
    部门名称
                            ...
                            <input type="text" class="form-control" style="" name="bumenmingcheng" value="${param.bumenmingcheng}"/>                        
</div>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="${map.id}" pid="">
                        ...
                        <td align="center">
                                                                ...
                                                                <a href="bumen_updt.do?id=${map.id}">编辑</a>
                                                                <a href="bumen_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    </c:forEach>
